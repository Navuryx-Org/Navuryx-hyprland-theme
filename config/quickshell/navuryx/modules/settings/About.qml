    ...
    ContentSection {
        ...
        RowLayout {
            ...
            ColumnLayout {
                ...
                StyledText {
                    text: "https://github.com/Navuryx/dots-hyprland"
                    font.pixelSize: Appearance.font.pixelSize.normal
                    textFormat: Text.MarkdownText
                    onLinkActivated: (link) => {
                        Qt.openUrlExternally(link)
        ...
        Flow {
            ...
            RippleButtonWithIcon {
                ...
                mainText: Translation.tr("Documentation")
                onClicked: {
                    Qt.openUrlExternally("https://Navuryx.github.io/dots-hyprland-wiki/en/ii-qs/02usage/")
                }
            }
            RippleButtonWithIcon {
                materialIcon: "adjust"
                ...
                onClicked: {
                    Qt.openUrlExternally("https://github.com/Navuryx/dots-hyprland/issues")
                }
            }
            RippleButtonWithIcon {
                materialIcon: "forum"
                ...
                onClicked: {
                    Qt.openUrlExternally("https://github.com/Navuryx/dots-hyprland/discussions")
                }
            }
            RippleButtonWithIcon {
                ...
                onClicked: {
                    Qt.openUrlExternally("https://github.com/sponsors/Navuryx")
                }
            }
